...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _loadUserLocation() async {
    ...
    try {
      ...
      if (mounted) setState(() => _loadingUserPos = false);
    }
  }
  ...
  double? _distanceToTodo(Todo todo) {
  ...
  Widget build(BuildContext context) {
    ...
    final formatted =
        "${lastOpen.day}/${lastOpen.month}/${lastOpen.year} "
        "${lastOpen.hour}:${lastOpen.minute.toString().padLeft(2, '0')}";
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(child: Text("Terakhir dibuka: $formatted")),
                      if (_loadingUserPos)
                        const SizedBox(
                          width: 18,
                          height: 18,
                ...
                if (_todos.isEmpty)
                  Container(
                    ...
                    child: const Text(
                      "Belum ada Todo. Tekan tombol + untuk membuat Todo pertama kamu.",
                    ),
                  ),

                ..._todos.map((todo) {
                  final dist = _distanceToTodo(todo);
                  final distText = dist == null ? null : _formatDistance(dist);
